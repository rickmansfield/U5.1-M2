...
""" MY SOLUTION as a result of the UPER "Reflect """
def lastNItemsinAList(anyList, anyNumber):
    ...
    if anyNumber == 0:
        return []
    return anyList[start: end]

# tests
print(lastNItemsinAList([1, 2, 3, 4, 5], 1))  # ➞ [5]
print(lastNItemsinAList([4, 3, 9, 9, 7, 6], 3))  # ➞ [9, 7, 6]
print(lastNItemsinAList([1, 2, 3, 4, 5], 7))  # ➞ "invalid"
print(lastNItemsinAList([1, 2, 3, 4, 5], 0))  # ➞ []
